...
- 实际生成三份脱敏文件：通用 Markdown 简历、CodeCV 简历和项目简介卡；同时生成不含来源信息的校验结果。
...
- `匿名简历-通用版.md`：适合一般 Markdown 编辑器的公开匿名简历。
- `匿名简历-CodeCV.md`：可直接粘贴到 CodeCV 的版本。
- `项目简介卡.md`：说明匿名项目的定位、服务场景、核心能力、技术要点和验证状态。
- `简历校验结果.json`：仅记录文件摘要与校验结论，不包含项目地址或个人信息。
