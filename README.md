...
- 🛠️ 根据已有简历给出逐项目优化建议，并产出可直接替换的改写稿。
...
```text
使用 $developer-resume-writer，优化我的现有简历。
请先指出每个项目简介和项目亮点的问题，再给出可直接替换的改写稿。
```
...
项目简介会固定说明：服务场景、核心功能闭环、解决的问题和技术机制；亮点会用一句自然的话写清做法、关键机制和结果，让每一句都能讲明白。🧩

## 写得靠谱的小原则

- 先说清项目是什么，再写技术方案和项目产出。
- 项目简介必须讲出核心功能，而不是只写“基于某某技术搭建”。
- 项目亮点必须和核心功能对应；没有明确数据时，只写可确认的功能结果，不硬塞性能或业务涨幅。
